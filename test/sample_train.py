...
from models import EEGTCNet, DeepConvNet
from data_loading import prepare_features
...
data_path = '../../Dataset/BCICIV_2a_mat/'
F1 = 8
KE = 32
KT = 4
L = 2
...
for subject in range(9):
    ...
    with open('results_deepconvnet.txt', 'a') as f:
        f.write('Subject: {:} Accuracy: {:}\n'.format(subject+1,accuracy_of_test))
